    ...
    <body>
        <%
            try {
                ...
                application.setAttribute("dentist", user);
                            ...
                            <form class="form-inline flex-container">
                                ...
                                <fieldset class="flex-item">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input class="span3" id="firstName" value="${dentist.firstName}">
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="lastName">Last Name </label>
                                        <input class="span3" id="lastName" value="${dentist.lastName}">
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="flex-item">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input class="span3" id="email" value="${dentist.email}">
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="password">Password </label>
                                        <input class="span3" id="password" value="${dentist.password}">
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="flex-item">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input class="span3" id="id" disabled="true" value="${dentist.id}">
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="office">Office </label>
                                        <input class="span3" id="office" disabled="true" value="${dentist.office}">
                                    </div>
                                </fieldset>
